...
namespace Example
{
    class PlayerCube : Entity
    {
        ...
        protected override void OnCreate()
        {
            ...
            {
                float x = CubeSpawnOffset.X + Aspect.Random.Float() * CubeSpawnRange.X;
                float y = CubeSpawnOffset.Y + Aspect.Random.Float() * CubeSpawnRange.Y;
                CreateCube(new Vector2(x, y), Aspect.Random.Float() * 10.0f, i);
            }
        }
