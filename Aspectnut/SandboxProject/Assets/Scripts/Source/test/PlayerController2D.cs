...
namespace PlayerController2D
{
    class PlayerController2D : Entity
    {
        ...
        {   
            ...
            RaycastHit2D[] groundCheck0 = Physics.Raycast2D(Translation.XY - groundRaycastOffset, Vector2.Down, 0.52f); // change these when you have a new character model
            RaycastHit2D[] groundCheck1 = Physics.Raycast2D(Translation.XY + groundRaycastOffset, Vector2.Down, 0.52f); // change these when you have a new character model
            RaycastHit2D[] wallCheckLeft = Physics.Raycast2D(Translation.XY, Vector2.Left, 0.52f); // change these when you have a new character model
            RaycastHit2D[] wallCheckRight = Physics.Raycast2D(Translation.XY, Vector2.Right, 0.52f); // change these when you have a new character model
