        ...
        protected override void OnUpdate(float ts)
        {
            ...
            if (m_Destroy)
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    Vector3 dir = new Vector3(Aspect.Random.Float() * 2.0f - 1.0f, Aspect.Random.Float() * 2.0f - 1.0f + 1.0f, Aspect.Random.Float() * 2.0f - 1.0f);
                    Vector3 force = dir * Aspect.Random.Float() * 5.0f;
