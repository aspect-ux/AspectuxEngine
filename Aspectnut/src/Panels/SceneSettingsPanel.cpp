...
//#include "Aspect/EcsFramework/System/Render/EnvironmentSystem.h"
//temp
	...
	void SceneSettingsPanel::OnImGuiRender(bool* pOpen)
	{
		...
		else if (ModeManager::mSceneMode == SceneMode::EnvironmentHdr)
		{
			if (ImGuiWrapper::TreeNodeExStyle1((void*)"Environment Hdr", "Environment Hdr"))
			{
				...
				ImGui::NextColumn();
				ImGui::SliderFloat("##SkyBox Lod", &Scene::environmentSettings.SkyBoxLod, 0.0f, 10.0f);
				ImGui::EndColumns();
				...
				ImGui::Text("Exposure");
				ImGui::NextColumn();
				ImGui::SliderFloat("##Exposure", &Scene::environmentSettings.exposure, 0.0f, 10.0f);
				ImGui::EndColumns();
