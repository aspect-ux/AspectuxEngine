...
#include "Aspect/Utilities/ContainerUtils.h"
...
#define AS_IGNORE_EXTERNAL_ALLOCATIONS
	...
	{
		AS_CORE_ASSERT(!s_ProfilerState, "Trying to initialize Script Profiler multiple times!");
		s_ProfilerState = anew ProfilerState();
...
#ifdef AS_IGNORE_EXTERNAL_ALLOCATIONS
