...
namespace std {
	...
	template<>
	struct hash<Aspect::AssemblyMetadata>
	{
		size_t operator()(const Aspect::AssemblyMetadata& metadata) const
		{
			size_t result = 0;
			Aspect::Utils::HashCombine(result, metadata.Name);
			Aspect::Utils::HashCombine(result, metadata.MajorVersion);
			Aspect::Utils::HashCombine(result, metadata.MinorVersion);
			Aspect::Utils::HashCombine(result, metadata.BuildVersion);
			Aspect::Utils::HashCombine(result, metadata.RevisionVersion);
			return result;
		}
	};
