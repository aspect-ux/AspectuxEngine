...
namespace Aspect {
	...
	public:
		...
		virtual void CopyFrom(const AspectRef<FieldStorageBase>& other) = 0;
	...
	public:
		...
		{
			AS_CORE_VERIFY(sizeof(T) == m_FieldInfo->Size);
		...
		virtual void CopyFrom(const AspectRef<FieldStorageBase>& other)
		{
			AspectRef<FieldStorage> fieldStorage = other.As<FieldStorage>();
	...
	public:
		...
		virtual void CopyFrom(const AspectRef<FieldStorageBase>& other)
		{
			AspectRef<ArrayFieldStorage> fieldStorage = other.As<ArrayFieldStorage>();
