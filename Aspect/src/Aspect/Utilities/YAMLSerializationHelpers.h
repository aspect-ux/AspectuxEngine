...
namespace YAML {
	...
	template<>
	struct convert<Aspect::AssetHandle>
	{
		static Node encode(const Aspect::AssetHandle& rhs)
		{
			Node node;
		...
		static bool decode(const Node& node, Aspect::AssetHandle& rhs)
		{
