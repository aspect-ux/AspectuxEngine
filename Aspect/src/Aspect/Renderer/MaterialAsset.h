...
namespace Aspect {
	...
	public:
		...
		MaterialAsset(AspectRef<Material> material);
		~MaterialAsset();
		...
		AspectRef<Material> GetMaterial() const { return m_Material; }
		void SetMaterial(AspectRef<Material> material) { m_Material = material; }

		bool IsTransparent() const { return m_Transparent; }
	private:
		void SetDefaults();
	private:
		AspectRef<Material> m_Material;
	...
	public:
		...
		{
			AS_CORE_ASSERT(HasMaterial(materialIndex));
