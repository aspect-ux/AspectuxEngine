...
#include "Aspect/Asset/AssetImporter.h"
...
namespace Aspect {
	...
	public:
		...
		virtual AspectRef<Asset> GetAsset(AssetHandle assetHandle) override;
		virtual void AddMemoryOnlyAsset(AspectRef<Asset> asset) override;

		virtual std::unordered_set<AssetHandle> GetAllAssetsWithType(AssetType type) override;
		virtual const std::unordered_map<AssetHandle, AspectRef<Asset>>& GetLoadedAssets() override { return m_LoadedAssets; }
		virtual const std::unordered_map<AssetHandle, AspectRef<Asset>>& GetMemoryOnlyAssets() override { return m_MemoryAssets; }
	...
	private:
		std::unordered_map<AssetHandle, AspectRef<Asset>> m_LoadedAssets;
		std::unordered_map<AssetHandle, AspectRef<Asset>> m_MemoryAssets;
