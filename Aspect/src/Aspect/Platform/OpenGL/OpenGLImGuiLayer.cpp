...
void ImGuiLayer::OnEvent(Event& e)
{
	...
	dispatcher.Dispatch<KeyPressedEvent>(AS_BIND_EVENT_FN(ImGuiLayer::OnKeyPressedEvent));// 区分
	dispatcher.Dispatch<KeyTypedEvent>(AS_BIND_EVENT_FN(ImGuiLayer::OnKeyTypedEvent));// 区分
