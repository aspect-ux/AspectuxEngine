...
namespace Aspect
{
	...
	{
		AS_CORE_ERROR("GLFW Error ({0}): {1}", error, description);
	}
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		AS_CORE_INFO("Creating window {0} ({1}, {2})", props.Title, props.Width, props.Width);
		...
		// create context in correct platform
		m_Context = GraphicsContext::Create(m_Window); // create a context
