...
namespace Aspect {
	...
	public:
		...
		const AspectRef<Scene>& GetEntityScene() const { return m_EntityScene; }
		AspectRef<Scene> GetEntityScene() { return m_EntityScene; }
	...
	private:
		void InitializeScene(const AspectRef<Scene>& scene);
		void Clear();
