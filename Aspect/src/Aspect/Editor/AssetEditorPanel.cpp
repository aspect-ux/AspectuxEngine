...
//#include "Aspect/Editor/NodeGraphEditor/SoundGraph/SoundGraphGraphEditor.h"
//
...
namespace Aspect {
	...
	void AssetEditorPanel::SetSceneContext(const AspectRef<Scene>& context)
	{
	...
	void AssetEditorPanel::OpenEditor(const AspectRef<Asset>& asset)
	{
		if (asset == nullptr)
			return;
	...
	AspectRef<Scene> AssetEditorPanel::s_SceneContext = nullptr;
